  ...
  for (var i=0; i<trpDtl.length;i++) {
    ...
    if (date != brkDate) {
      ...
      trp.push(["<div class='text-start text-primary h4'>" + dispDate, 
                '<div class="text-end"><a  target="_blank" href=' + googleTimelineHref + '><img class="img-thumbnail border-0 bg-transparent" width="40" height="40" src=  "images/icons/google-my-locn-hist.jpg" /></a>'
              ])
